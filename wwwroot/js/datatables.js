 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/moment-2.29.4/dt-2.3.4/cr-2.1.1/r-3.0.6/sl-3.1.0
 *
 * Included libraries:
 *   jQuery 3.7.0, Moment 2.29.4, DataTables 2.3.4, ColReorder 2.1.1, Responsive 3.0.6, Select 3.1.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/jq-3.7.0/moment-2.29.4/dt-2.3.4/cr-2.1.1/r-3.0.6/sl-3.1.0",
